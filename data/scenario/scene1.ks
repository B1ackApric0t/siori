...
[role]
[position layer="message0" left=100 top=460 width=1180 height=260 opacity=&sf.mopacity frame="frame2.png" page=fore visible=true]
...
[movie storage="amehazuOP3.mp4" skip=true volume="&sf.current_bgm_vol"]
[else]
[movie storage="amehazuOP3.mp4" skip=true volume=0]
[endif]
[mask time="700"]
[M0]
[eval exp="sf.SM1=1"]
